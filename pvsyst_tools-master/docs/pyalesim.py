# -*- coding: utf-8 -*-
"""
Combine pvlib.tracking to compute the angles, and pvlib.bifacial to compute the irradiance.

pv = SingleAxisTracker()
tracking = pv.singleaxis()
irrads = pvlib.bifacial.pvfactors_timeseries(surface_azimuth=tracking['surface_azimuth' ], ...)

irrads will have two poa_front values (before and after accounting for reflections) and two poa_back values.

1 - SingleAxisTracker() ------------------------ ?
 - tracking = pv.singleaxis() ----------------- OK
 - irrads ------------------------------------- no
 - simulação anual e corrigir para diário ----- no
"""
...
# pv = pvlib.tracking.SingleAxisTracker()
...
#tmy_data['surface_tilt']=0
#tmy_data['surface_azimuth']=0
#tmy_data['axis_azimuth']=0
...
# irrads = pvlib.bifacial.pvfactors_timeseries(solar_azimuth=solpos['azimuth'], 
#                                               solar_zenith=solpos['zenith'], 
#                                               surface_azimuth=backtracking_angles['surface_azimuth'], 
#                                               surface_tilt=backtracking_angles['surface_tilt'], 
#                                               axis_azimuth=0, #criar vetor com 180º
#                                               timestamps=tmy_data.index, 
#                                               dni=tmy_data['DNI'], 
#                                               dhi=tmy_data['DHI'], 
#                                               gcr=0.33, 
#                                               pvrow_height=2.35, 
